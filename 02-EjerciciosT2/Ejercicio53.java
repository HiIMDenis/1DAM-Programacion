...
public class Ejercicio53 {
    ...
    // Creamos un objeto TreeMap para almacenar las asociaciones
    // entre matrículas y colores de coches
    Map<String, Color> coches = new TreeMap<>();

    // Añadimos algunas asociaciones a nuestro objeto TreeMap
    ...
    if (coches.containsKey(matricula)) {
      ...
      System.out.println("El color del coche con matricula "+matricula+
              " es " + coches.get(matricula));
    } else {
      // Si no existe, mostramos un mensaje
      System.out.println("No existe esa matricula");
    }
    
    //Treemap lo que hace es ordena los objetos con un orden mientras que el 
    //hasmap no mantiene un orden.
    }
